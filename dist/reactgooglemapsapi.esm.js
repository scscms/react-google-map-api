...
function makeLoadScriptUrl(_ref) {
  ...
  !googleMapsApiKey ? process.env.NODE_ENV !== "production" ? invariant(false, 'key is required') : invariant(false) : void 0;
  !language ? process.env.NODE_ENV !== "production" ? invariant(false, 'key is required') : invariant(false) : void 0;
